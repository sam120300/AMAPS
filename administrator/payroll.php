...
<div class="container-fluid">
        ...
        <div class="col-auto sidebar" id="sidebar">
                ...
                <div class="list-group">
                    ...
                    <a href="../administrator/payroll.php" class="d-flex align-items-center list-group-item list-group-item-action  activated">
            ...
            <div class="col main-content" id="main-content">
                <nav class="navbar">
                    <div class="container-fluid header-bar">
                        ...
                        <h1 class="navbar-brand">Payroll</h1>
                    </div>
                </nav>
                ...
                <div class="container" style="width: 450px; height: 250px; background-color: #141E46; border-radius: 15px; padding: 20px;">
                    <form action="" method="get" class="">
                        ...
                        <button type="submit" class="w-100"><i class="fa fa-eye fa-xxl"> </i> View Payroll</button>
                    </form>
                </div>
                <!-- <div class="container">
                <center>
