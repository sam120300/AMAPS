        ...
        <div class="col-auto sidebar" id="sidebar">
            ...
            <div class="col main-content" id="main-content">
                ...
                <div class="container clock-container">
                    <div class="row">
                        <div id="clock-date" class="clock clock-date col-6 col-md-6 col-lg-6 col-sm-4"></div>
                        <div id="clock-time" class="clock clock-time col-6 col-md-6 col-lg-6 col-sm-4"></div>
                    </div>
                    <div class="row w-100 d-flex justify-content-center">
                        <button type="submit" class="my-btn col-lg-6 col-md-6 col-sm-12 " id="clock-btn">CLOCK IN</button>
